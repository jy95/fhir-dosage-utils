...
import Schema from "@site/static/dosages/specs/event/multiple_items.json";
...
Don't forget you can use [dateTimeFormatOptions](/api/interface/Config) option to fit your needs
