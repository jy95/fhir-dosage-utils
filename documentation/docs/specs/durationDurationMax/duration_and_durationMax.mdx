---
description: duration and durationMax
title: ⏰ duration and durationMax
---

import CodeBlock from "@theme/CodeBlock";
import Schema from "@site/static/dosages/specs/durationDurationMax/duration_and_durationMax.json";
