---
description: asNeededCodeableConcept
title: 📌 asNeededCodeableConcept
---

import CodeBlock from "@theme/CodeBlock";
import Schema from "@site/static/dosages/specs/asNeeded/asNeededCodeableConcept.json";
...
Don't forget you can use [fromCodeableConceptToString](/api/interface/Params) option to fit your needs
