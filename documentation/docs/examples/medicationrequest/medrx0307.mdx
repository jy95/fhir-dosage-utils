...
import Schema from "@site/static/dosages/examples/medicationrequest/medrx0307.json";
...
Source: [HL7](https://www.hl7.org/fhir/medicationrequest0307.html) - "Order with as needed (PRN) dosage - Percocet - completed with link to encounter, dispenseRequest and substitution"
